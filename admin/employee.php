...
<script>
	$(document).ready(function() {
		...
		$('#dt-basic-example').dataTable(
		{
			...
			serverSide: true,
			order: [[ 0, "asc" ]],
			ajax: "employeeres.php",
			columns: [
				{ title: 'ID', data:0, visible:false },
				{ title: 'EMPLOYEE ID', data:1 },
				{ title: 'EMPLOYEE NAME', data:2 },
				{ title: 'EMPLOYMENT POSITION', data:3 },
				{ title: 'EMPLOYEE PICTURE', data:4, visible: false},
				{ title: 'EMPLOYEE CONTACT NO.', data:5 },
				{ title: 'EMPLOYEE EMAIL', data:6 },
				{ title: 'DATE HIRED', data:7 },
			],
			dom:
