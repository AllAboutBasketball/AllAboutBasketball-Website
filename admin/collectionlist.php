									...
									<div class="form-row">
										...
										<div class="col-md-6 mb-3">
                                            ...
                                            <select name="collection" id="collection" class="form-control" required>
												...
												<option value="LIMITED RANDOM DESIGN">LIMITED RANDOM DESIGN</option>
											</select>
										</div>
									</div>
									<div class="form-row">
...
<script>
	$(document).ready(function() {
		...
		$('#dt-basic-example').dataTable(
		{
			...
			serverSide: true,
			order: [[ 0, "asc" ]],
			ajax: "collectionlistres.php",
			columns: [
				{ title: 'No.', data:0 },
				{ title: 'PRODUCT SALES', data:1 },
				{ title: 'COLLECTION', data:2 },
				{ title: 'IMAGE', data:3 },
				{ title: 'STATUS', data:4 },
				{ title: 'TAGGING', data:5 },
				{ title: 'ACTION', data:6 },
			],
			dom:
	...
	function update(id){
		$.ajax({
			url:'collectionlistupdate.php?id='+id,
			type:'post',
